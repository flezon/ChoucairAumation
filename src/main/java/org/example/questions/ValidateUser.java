...
public class ValidateUser implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        //String actualFullName = Text.of(candidateRow.findBy(By.xpath(".//td[3]"))).viewedBy(actor).asString();
        //String actualEmail = Text.of(candidateRow.findBy(By.xpath(".//td[4]"))).viewedBy(actor).asString();
